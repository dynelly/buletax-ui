...
import { SampleModule, EmployeeModule, DeductionModule } from './module'
...
Vue.use(EmployeeModule, { store, router })
Vue.use(DeductionModule, { store, router })

/**
 *  一定要使用 render函数创建app,这样就不需要依赖完整的esm，也就是不需要打包vue的编译模块了，
 *  vue的模板编译模块体积大约是25KB左右
 */
